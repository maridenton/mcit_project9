...
object Producer extends App {
  ...
  val source: BufferedSource = scala.io.Source.fromFile("/Users/akhileshreddyadala/Downloads/Trips.csv")
  for (trip <- source.getLines) {
    tripProducer.send(new ProducerRecord[Int, String]("bdss2001_akhileshadala_trips",trip))
  }
  tripProducer.flush()
}
